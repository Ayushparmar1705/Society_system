...
export default function Signup({ societyData, flatCode, handleOnChange }) {
  ...
  return (
    <div className=' bg-gray-200 h-screen flex items-center justify-center shadow-lg '>
      <div className='p-5 bg-white w-96  p-4 text-center  h-98 rounded' >
        ...
        <div className='p-4'>
          <input onChange={handleOnChange} className='p-2 border-2 rounded w-full border-gray-200 focus:outline-none  focus:border-blue-400 focus:transition focus:duration-100 rounded-lg' type='text' placeholder='Enter your username'></input>
        </div>
        <div className='p-4'>
        ...
        <div className='p-4'>
          <input onChange={handleOnChange} className='p-2 border-2 rounded w-full border-gray-200 focus:outline-none  focus:border-blue-400 focus:transition focus:duration-100 rounded-lg' type='text' placeholder='Enter your phone'></input>
        </div>
        <div className='p-4'>
          <select onChange={handleOnChange} className='p-2 border-2 rounded w-full border-gray-200 focus:outline-none  focus:border-blue-400 focus:transition focus:duration-100 rounded-lg'>
        ...
        <div className='p-4'>
          <select className='p-2 border-2 rounded w-full border-gray-200 focus:outline-none  focus:border-blue-400 focus:transition focus:duration-100 rounded-lg'>
